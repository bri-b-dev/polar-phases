...
fun defaultZones(restingHr: Int = 62, maxHr: Int = 179): List<KarvonenZone> {
    ...
    return listOf(
        KarvonenZone("Recovery",  0xFF9E9E9E.toInt(), bpm(0.50), bpm(0.60)),
        KarvonenZone("Endurance", 0xFF42A5F5.toInt(), bpm(0.60) + 1, bpm(0.70)),
        KarvonenZone("Tempo",     0xFF66BB6A.toInt(), bpm(0.70) + 1, bpm(0.80)),
        KarvonenZone("Threshold", 0xFFFFEE58.toInt(), bpm(0.80) + 1, bpm(0.90)),
